...
export const projects: Project[] = [
  {
    ...
    screenshots: [
      { src: "/screenshots/occ-dashboard.png", label: "HQ Dashboard — lessons, revenue, live activity feed, and attention alerts at a glance" },
      { src: "/screenshots/occ-pipeline.png", label: "Client Conversion Tracker — multi-stage sales pipeline with prospect management" },
      { src: "/screenshots/occ-marketing.png", label: "AI Marketing Command Center — ad-spend analytics and an LLM-assisted content calendar" },
      { src: "/screenshots/occ-analytics.png", label: "Analytics — revenue trends, KPIs, and lesson hours rolled up across every market" },
      { src: "/screenshots/occ-tutors.png", label: "Workforce — tutor metrics, labels, and performance tracking" },
  ...
  },
  {
    ...
    screenshots: [
      { src: "/screenshots/workforce-portal-dashboard.png", label: "Dashboard — contractor command center with announcements and updates" },
