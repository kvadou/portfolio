...
import { BrowserFrame } from "@/app/components/browser-frame";
      ...
      <section className="hero-gradient">
        <div className="mx-auto max-w-6xl px-6 pb-14 pt-16 sm:pt-20">
          ...
          <div className="mt-8 grid gap-12 lg:grid-cols-[1fr_1.05fr] lg:items-center">
            ...
            {/* Hero screenshot */}
            <BrowserFrame url={project.demoLabel}>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {project.highlights.map((h, i) => (
              <Reveal key={i} delay={i * 50}>
                <div className="flex h-full gap-4 rounded-lg border border-border bg-card p-4 transition-all hover:border-accent/20">
