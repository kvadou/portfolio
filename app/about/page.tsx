  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
      ...
      <div className="mt-8 space-y-4 text-muted leading-relaxed">
        ...
        <p>
          I specialize in replacing fragmented SaaS tooling with unified,
          custom-built platforms that fit exactly how a business operates —
          saving tens of thousands annually while delivering better user
          experiences.
        </p>
      </div>
